            ...
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Theaters </span></a
                >
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="theater.php" class="sidebar-link"
                      ><i class="mdi mdi-table-large"></i
                      ><span class="hide-menu"> View Theaters </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="addtheater.php" class="sidebar-link"
                      ><i class="mdi mdi-plus-one"></i
                      ><span class="hide-menu"> Add Theaters </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="updatetheater.php" class="sidebar-link"
                      ><i class="mdi mdi-plus-one"></i
                      ><span class="hide-menu"> Update Theaters </span></a
                    >
                  </li>
                </ul>
              </li>
              <li class="sidebar-item">
                <a
                  ...
                  aria-expanded="false"
                  ><i class="mdi mdi-theater"></i
                  ><span class="hide-menu">Movies </span></a
                >
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="moviestable.php" class="sidebar-link"
                      ><i class="mdi mdi-table-large"></i
                      ><span class="hide-menu">Movies</span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="addmovies.php" class="sidebar-link"
                      ><i class="mdi mdi-plus-one"></i
                      ><span class="hide-menu">Add Movies</span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="deletemovie.php" class="sidebar-link"
                      ><i class="mdi mdi-plus-one"></i
                      ><span class="hide-menu">Delete Movies</span></a
                    >
                  </li>
                </ul>
              </li>
